...
curs_dron.o: curs_dron.c curs_dron.h
	gcc -c -g -Wall -lconio --std=c11 -o curs_dron.o curs_dron.c

dron_move.o: dron_move.c
	gcc -c -g -Wall -lconio --std=c11 -o dron_move.o dron_move.c

dron_varios_func.o: dron_varios_func.c
	gcc -c -g -Wall -lconio --std=c11 -o dron_varios_func.o dron_varios_func.c
